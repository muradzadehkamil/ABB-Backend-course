...
public class Homework4 {
    public static void main(String[] args) {
        ...
        // 1
        Human Nazrin= new Human("Kamil","Muradzade",1005,105,new Human("Murad","Aghayev",1993),new Human(),new Pet("cat","Mur", 3,60, new String[]{"eat", "play", "sleep"}));
        Human Ariz= new Human("Habil","Muradov",1963,107,new Human(),new Human("Nijat","Sardarov",1998),new Pet("cat","Mur", 3,60, new String[]{"eat", "play", "sleep"}));
        Human Ulker= new Human("Salman","Babazade",11995,110,new Human(),new Human("Miri", "Huseynli",1994),new Pet("cat","Mur", 3,60, new String[]{"eat", "play", "sleep"}));
